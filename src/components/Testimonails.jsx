...
const Testimonails = () => {
  return (
    ...
    initial={{opacity:0, x:200}}
        ...
        viewport={{once: true}}
    className="container max-auto py-10 lg:px-32 w-full overflow-hidden" id="Testimonails">
       ...
       <div className="flex flex-wrap justify-center gap-8">
        {testimonialsData.map((testimonials, index) => (
            <div key="index" className="max-w-[340px] border shadow-lg rounded px-8 py-12 text-center">
                <img src={testimonials.image} className="w-20 h-20 rounded-full mx-auto mb-4" alt={testimonials.alt} />
